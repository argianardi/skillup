            ...
            @auth
                <div class="flex gap-[10px] items-center">
                    ...
                    <div class="w-[56px] h-[56px] overflow-hidden rounded-full flex shrink-0">
                        <a href="{{ route('dashboard') }}" class="w-full h-full">
            ...
            <div
                ...
                <div class="flex flex-col gap-3">
                    <div
                        ...
                        <a href="{{ route('front.course.details', $course) }}">
                    ...
                    @forelse ($course->course_videos as $video)
                        @php
                            $currentVidoeId = Route::current()->parameter('courseVideoId');
                            $isActive = $currentVidoeId == $video->id;
                        @endphp
                        ...
                        @if ($isActive)
                            <div
                                ...
                                <a href="{{ route('front.learning', [$course, 'courseVideoId' => $video->id]) }}">
                                    <p
                                        class="font-semibold group-hover:text-white transition-all duration-300 text-white">
                                        {{ $video->name }}</p>
                                </a>
                            </div>
                        @else
                                ...
                                <div class="flex items-center gap-3">
                                    <a href=""
                                        ...
                                        <img src="{{ Storage::url($course->teacher->user->avatar) }}"
                                            class="w-full h-full object-cover" alt="teacher avatar">
                                    </a>
