        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg gap-y-5">
                <div class="flex flex-row gap-x-10">
                    ...
                    <div class="flex flex-col gap-y-10">
                        ...
                        <div>
                            ...
                            @if ($subscribeTransaction->is_paid)
                                <span
                                    class="px-3 py-2 text-sm font-bold text-white bg-green-500 rounded-full">ACTIVE</span>
                            @else
                                <span
                                    class="px-3 py-2 text-sm font-bold text-white bg-orange-500 rounded-full">PENDING</span>
                            @endif
                        </div>
                        <div>
                    ...
                    <div>
                        <img src="{{ Storage::url($subscribeTransaction->proof) }}" alt="transaction">
                    </div>
                </div>
                <hr class="my-5">
                @if (!$subscribeTransaction->is_paid)
